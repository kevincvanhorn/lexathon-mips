...
fin: .asciiz "TestDictionary.txt" #filename for input
...
#**************
	...
	addi $v0, $zero, 4 # Load "print string" SYSCALL service into register $v0
	la $a0, pPrintMenu2 # Load argument value, to print, into $a0
	syscall
	
	# Get input for choice into $v0
	li $v0, 5 # Load "read integer" SYSCALL service into register $v0
	syscall
	move $t0, $v0 # move input into temporary register
...
printMenuElse:	
	...
	jal pSeparator_ # Print separating line
printMenuChoice:
	# Print pPrintMenu2 (second prompt)
	addi $v0, $zero, 4 # Load "print string" SYSCALL service into revister $v0
	la $a0, pPrintMenu2 # Load argument value, to print, into $a0
...
pNew_Line:
	li $v0, 4 # Call "print string" SYSCALL and print a new line
	la $a0, pNewLine
	syscall
	jr $ra

pSeparator_:
	li $v0, 4 # Call "print string" SYSCALL and print a separator for formatting ----------------
	la $a0, pSeparator
	syscall
	jr $ra
